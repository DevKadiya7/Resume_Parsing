...
_WEB_FRONTEND = (
    "HTML", "CSS", "SASS", "React", "Angular", "Vue", "Next.js", "Nuxt.js",
    "Svelte", "jQuery", "Redux", "Tailwind CSS", "Bootstrap", "Webpack",
)

_WEB_BACKEND = (
    "FastAPI", "Flask", "Django", "Node.js", "Express", "Spring", "Spring Boot",
    "Ruby on Rails", "Laravel", "ASP.NET", ".NET", "NestJS", "GraphQL", "REST",
    "gRPC", "Microservices",
)

_DATABASES = (
    "SQL", "PostgreSQL", "MySQL", "MongoDB", "Redis", "SQLite", "Oracle",
    "Cassandra", "DynamoDB", "Elasticsearch", "MariaDB", "Neo4j", "Firebase",
)

_CLOUD_DEVOPS = (
    "AWS", "Azure", "GCP", "Docker", "Kubernetes", "Terraform", "Ansible",
    "Jenkins", "CI/CD", "GitHub Actions", "GitLab CI", "Nginx", "Apache",
    "Linux", "Bash", "PowerShell", "Vagrant", "Prometheus", "Grafana",
)

_DATA_ML = (
    "TensorFlow", "PyTorch", "Keras", "Pandas", "NumPy", "Scikit-learn",
    "OpenCV", "NLTK", "spaCy", "Spark", "Hadoop", "Tableau", "Power BI",
...
_TOOLS_PRACTICES = (
    ...
    "Scrum", "Kanban", "Selenium", "Pytest", "JUnit", "Postman", "Figma",
    "Excel",
)
